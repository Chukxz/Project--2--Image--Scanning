# V 1.0, uses only PIL (Python Imaging Library)
...
int_dir = path.join('Edge_Detection_V1.0','Resources','Generated_Images')
...
class MatchIt:
    def __init__(self,input,vallist=['h','s','e','c','u','m','n','d']):
        self.input = input
        self.res = ''
...
def check(value,vallist=['h','s','e','c','u','m','n','d']):
...
def convertImg():
    try:
        ...
        img_folder_path = path.join('Edge_Detection_V1.0','Resources','Images')
