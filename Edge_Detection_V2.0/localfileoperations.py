if __name__ != "__main__":
    ...
    intermediate_dir =  path.join('Edge_Detection_V2.0','Resources','Generated_Images')
    ...
    def copyimagefile(file_name,ext):
        ...
        src_file_path = path.join('Edge_Detection_V2.0','Resources','Images',full_file_name)
        resized_img_path = path.join('Edge_Detection_V2.0','Resources','Images',resized_img_file_name)
